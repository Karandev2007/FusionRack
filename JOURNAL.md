...
Day 2 (28/7/25): (12h so far)
- discussed some drawbacks and issues with my current designs and materials with shub, and sourced more parts. for the pillars on the edge, i will now use 8mm lead screw stainless steel rods. with them, i will use T8 circular single-start nuts to attach to the plates. im lucky that the filaments in my country are ABS, still i will keep the thickness greater, including cross strips to distribute the weight on the bottom and second middle plate.

i will use honey comb plates with magnets for front and back side of platforms gaps, and on right and left sides a cooling fan with honey comb walls.

<img width="603" height="278" alt="image" src="https://github.com/user-attachments/assets/336f187e-4496-4737-b66d-4fb465ab3b96" />

<img width="1200" height="742" alt="image" src="https://github.com/user-attachments/assets/def6b059-7df7-42e3-9319-2760df9fffd5" />
<img width="1200" height="742" alt="image" src="https://github.com/user-attachments/assets/91680fa1-2365-4a07-9ff1-41030790d4fb" />

- i got to know that Creality from Printing-Legion is not available. so im forced to use Bambu Lab A1 Mini which means 180mm x 180mm / 7*7 inches, means now we cant place our mini-pc also space for rpi's will also be decreased, but i came up with a new plan reference image is below:

<img width="244" height="623" alt="image" src="https://github.com/user-attachments/assets/08d96bee-7353-41c6-b29a-be40506a6c37" />

- i have restructured whole lab, so it will be increased in height from 12 inches to 16 or 19 depending upon lead screw rods. but we got plus points, as now we will vertically install all pi's and mainly our mini-pc's so we can install like 4 mini pc instead of 1, just need to find a way to fit any minipc on its place maybe using moving mount or something, major companies like HP, lenovo, dell all have almost same size just 2-4 inches difference which can affect for sure.
...
## some polished structure images :D
<img width="404" height="632" alt="image" src="https://github.com/user-attachments/assets/a96da521-1184-4b00-b673-3a6abc81decb" />
<img width="404" height="632" alt="image" src="https://github.com/user-attachments/assets/bcfeb414-4952-433d-af00-f2bd25293a0e" />

- removed handles from top plate cuz it needs alot of support while printing so we have now separate handles here:
<img width="496" height="209" alt="image" src="https://github.com/user-attachments/assets/afe6354a-b800-459e-a83e-62533263cdb6" />
